 ...
 */
namespace _YabeMovebender\Composer;

use _YabeMovebender\Composer\Autoload\ClassLoader;
use _YabeMovebender\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_YabeMovebender\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
